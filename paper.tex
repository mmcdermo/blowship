...
\includegraphics*[width=\linewidth]{gamma5graph.png}
...
Unfortunately, if peers discover eachother through Surge, he could ensure that any peer only knows about compromised peers (Effectively making $\phi = 1$).
